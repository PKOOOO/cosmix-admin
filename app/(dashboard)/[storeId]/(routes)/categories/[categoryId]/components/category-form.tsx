...
// The form schema is simplified to only require a name
...
export const CategoryForm: React.FC<CategoryFormProps> = ({ initialData }) => {
        ...
        try {
            ...
            if (initialData) {
                await axios.patch(
                    ...
                    data // Pass only the name
                );
            } else {
                await axios.post(`/api/${params.storeId}/categories`, data); // Pass only the name
            }
    ...
    const onDelete = async () => {
        ...
        try {
            ...
            toast.error("Ensure all services using this category are removed first.");
        } finally {
            setLoading(false);
        }
    };
