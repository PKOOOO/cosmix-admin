                                                                        ...
                                                                        {displayServices.map((service: any) => {
                                                                            ...
                                                                            return (
                                                                                <div
                                                                                    ...
                                                                                    `}
                                                                                    onClick={(e) => {
                                                                                        e.preventDefault(); // Prevent default to avoid double toggles if native constraints exist
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <div className="flex-1 select-none">
                                                                                        <h4 className={`text-lg(28px) font-semibold ${isChecked ? 'text-[#423120]' : 'text-foreground'}`}>
                                                                                            {service.name}
                                                                                        </h4>
